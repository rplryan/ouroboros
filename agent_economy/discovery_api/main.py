...
<div class="container">
  ...
  <div class="hero">
    ...
    <p>
      x402Scout indexes <span class="accent">250+ x402-payable services</span> — APIs that accept USDC micropayments on Base instead of API keys.
  ...
  <div class="install-block">
    <div class="section-title">Quick Install — Claude Desktop / Cursor / Windsurf</div>
    ...
    <div class="code-block"><span class="k">"x402-discovery"</span>: {<br>&nbsp;&nbsp;<span class="k">"url"</span>: <span class="s">"https://x402-discovery-api.onrender.com/mcp"</span><br>}</div>
  </div>

  <div class="links-row">
    <a href="https://github.com/rplryan/x402-discovery-mcp" class="btn btn-primary" target="_blank">
      &#9733; GitHub
    </a>
  ...
  <footer>
    ...
    # API / programmatic clients get JSON
    return JSONResponse(
        {
